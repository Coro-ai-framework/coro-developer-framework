...
| [desktop-packaging.md](desktop-packaging.md) | Engineers shipping the desktop app | Current desktop release shape, operator notes, and the next-platform plan with emphasis on Windows packaging |
